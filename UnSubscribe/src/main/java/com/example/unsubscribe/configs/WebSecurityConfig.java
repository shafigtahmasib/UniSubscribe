...
import com.example.unsubscribe.dao.JwtAuthenticationEntryPoint;
import com.example.unsubscribe.dao.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                ...
                .antMatchers("/api/user/*").hasAnyAuthority(Roles.USER.toString(),Roles.ADMIN.toString()).
                ...
                .logout().logoutRequestMatcher(new AntPathRequestMatcher("/logout")).logoutSuccessUrl("/authenticate");
